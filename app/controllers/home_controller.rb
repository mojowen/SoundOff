  ...
  def avatar_fallback
    begin
      if params[:fallback_type].downcase == 'partner'
        ...
        user = TWITTER_CLIENT.user('whitehouse')params[:twitter_screen_name].gsub('@',''))
      ...
      redirect_to 'https://abs.twimg.com/sticky/default_profile_images/default_profile_6.png'
    end
  end
